    ...
    items: [
      ...
      },
      {
        ...
        submenu: [
          ...
          { label: 'Laporan Kasir', path: '/cashier-report' },
          // { label: 'Operasional Kasir', path: '/cashier-operations' },
          // { label: 'Kas Harian', path: '/daily-cash' },
          // { label: 'Laba Rugi', path: '/profit-loss' },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        path: '/restock',
        submenu: [
          { label: 'Pembelian Stok', path: '/restock' },
          { label: 'Riwayat Stok', path: '/stock-history' },
          { label: 'Stok Opname', path: '/stock-opname' },
          { label: 'Kelola Stok', path: '/stock-conversion' },
        ],
      },
    ],
  },
