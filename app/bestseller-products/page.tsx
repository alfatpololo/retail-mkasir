    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pl-0 lg:pl-64 pb-10">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200/50 p-5 flex items-center gap-4 hover:shadow-md transition-shadow sm:col-span-2">
            <div className="w-12 h-12 rounded-xl bg-indigo-500 flex items-center justify-center shadow-md flex-shrink-0">
              <span className="ri-star-smile-line text-white text-xl" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-gray-600 mb-1">Produk Terlaris</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200/50 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-gray-600 mb-1">Total Terjual</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200/50 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-gray-600 mb-1">Rata-rata Terjual</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200/50 shadow-sm">
          <div className="p-4 flex flex-col md:flex-row items-center gap-3 border-b border-gray-200 bg-gray-50/50">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-lg bg-emerald-500 text-sm font-medium text-white hover:bg-emerald-600 cursor-pointer transition-colors"
            >
              <span className="ri-refresh-line text-base" />
              Terapkan Filter
            </button>
          </div>
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                ...
                {filteredData.map((row, index) => (
                  <tr key={row.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-sm text-right text-emerald-600 whitespace-nowrap font-semibold">
                      <span>{row.terjual.toLocaleString('id-ID')}</span>
                      <span className="text-gray-500 ml-1 text-xs">unit</span>
                    </td>
                    <td className="px-4 py-4 text-sm text-right text-gray-900 whitespace-nowrap font-semibold">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 px-4 py-4 border-t border-gray-200 bg-gray-50/50">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="ml-2 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white"
              >
